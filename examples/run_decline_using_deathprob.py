...
# prefer death_prob if present to avoid NaN-filled survival arrays
if 'death_prob_female' in data:
    ...
    proj_kwargs['survival_female'] = data.get('survival_female')
    proj_kwargs['survival_male'] = data.get('survival_male')

out = model.project(**proj_kwargs)

births = out['births']
base_year = 2020
print('Requested years 2025-2030 (decline factor 0.9 first 5 years):')
